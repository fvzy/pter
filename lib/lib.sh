...
#                                                                           #
# https://github.com/wffzy/pter/blob/master/LICENSE #
#                                                                           #
# This script is not associated with the official Pterodactyl Project.      #
# https://github.com/wffzy/pter                     #
#                                                                           #
#############################################################################
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/wffzy/pter"}
...
welcome() {
  ...
  output "https://github.com/wffzy/pter"
  output ""
